...
// PrivateAddressBookResponse private address book response
//
// swagger:model private_address_book_response
...
func (m *PrivateAddressBookResponse) validateResult(formats strfmt.Registry) error {
...
func (m *PrivateAddressBookResponse) UnmarshalBinary(b []byte) error {
	var res PrivateAddressBookResponse
