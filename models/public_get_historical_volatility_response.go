...
// PublicGetHistoricalVolatilityResponse public get historical volatility response
//
// swagger:model public_get_historical_volatility_response
type PublicGetHistoricalVolatilityResponse struct {
	BaseMessage
...
// Validate validates this public get historical volatility response
...
func (m *PublicGetHistoricalVolatilityResponse) validateResult(formats strfmt.Registry) error {
...
func (m *PublicGetHistoricalVolatilityResponse) UnmarshalBinary(b []byte) error {
	var res PublicGetHistoricalVolatilityResponse
