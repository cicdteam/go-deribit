...
// NewGetPublicGetIndexParams creates a new GetPublicGetIndexParams object
// with the default values initialized.
func NewGetPublicGetIndexParams() *GetPublicGetIndexParams {
	var ()
	return &GetPublicGetIndexParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetPublicGetIndexParamsWithTimeout creates a new GetPublicGetIndexParams object
...
// NewGetPublicGetIndexParamsWithContext creates a new GetPublicGetIndexParams object
...
// NewGetPublicGetIndexParamsWithHTTPClient creates a new GetPublicGetIndexParams object
...
/*GetPublicGetIndexParams contains all the parameters to send to the API endpoint
for the get public get index operation typically these are written to a http.Request
*/
