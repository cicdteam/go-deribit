...
// NewGetPublicGetOptionMarkPricesParams creates a new GetPublicGetOptionMarkPricesParams object
// with the default values initialized.
func NewGetPublicGetOptionMarkPricesParams() *GetPublicGetOptionMarkPricesParams {
	var ()
	return &GetPublicGetOptionMarkPricesParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetPublicGetOptionMarkPricesParamsWithTimeout creates a new GetPublicGetOptionMarkPricesParams object
...
// NewGetPublicGetOptionMarkPricesParamsWithContext creates a new GetPublicGetOptionMarkPricesParams object
...
// NewGetPublicGetOptionMarkPricesParamsWithHTTPClient creates a new GetPublicGetOptionMarkPricesParams object
...
/*GetPublicGetOptionMarkPricesParams contains all the parameters to send to the API endpoint
for the get public get option mark prices operation typically these are written to a http.Request
*/
