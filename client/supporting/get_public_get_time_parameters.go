...
// NewGetPublicGetTimeParams creates a new GetPublicGetTimeParams object
// with the default values initialized.
func NewGetPublicGetTimeParams() *GetPublicGetTimeParams {

	return &GetPublicGetTimeParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetPublicGetTimeParamsWithTimeout creates a new GetPublicGetTimeParams object
...
// NewGetPublicGetTimeParamsWithContext creates a new GetPublicGetTimeParams object
...
// NewGetPublicGetTimeParamsWithHTTPClient creates a new GetPublicGetTimeParams object
...
/*GetPublicGetTimeParams contains all the parameters to send to the API endpoint
for the get public get time operation typically these are written to a http.Request
*/
