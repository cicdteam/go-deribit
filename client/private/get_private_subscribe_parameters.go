...
// NewGetPrivateSubscribeParams creates a new GetPrivateSubscribeParams object
// with the default values initialized.
func NewGetPrivateSubscribeParams() *GetPrivateSubscribeParams {
	var ()
	return &GetPrivateSubscribeParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetPrivateSubscribeParamsWithTimeout creates a new GetPrivateSubscribeParams object
...
// NewGetPrivateSubscribeParamsWithContext creates a new GetPrivateSubscribeParams object
...
// NewGetPrivateSubscribeParamsWithHTTPClient creates a new GetPrivateSubscribeParams object
...
/*GetPrivateSubscribeParams contains all the parameters to send to the API endpoint
for the get private subscribe operation typically these are written to a http.Request
*/
