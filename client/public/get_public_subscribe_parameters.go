...
// NewGetPublicSubscribeParams creates a new GetPublicSubscribeParams object
// with the default values initialized.
func NewGetPublicSubscribeParams() *GetPublicSubscribeParams {
	var ()
	return &GetPublicSubscribeParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetPublicSubscribeParamsWithTimeout creates a new GetPublicSubscribeParams object
...
// NewGetPublicSubscribeParamsWithContext creates a new GetPublicSubscribeParams object
...
// NewGetPublicSubscribeParamsWithHTTPClient creates a new GetPublicSubscribeParams object
...
/*GetPublicSubscribeParams contains all the parameters to send to the API endpoint
for the get public subscribe operation typically these are written to a http.Request
*/
