...
// NewGetPrivateGetAddressBookParams creates a new GetPrivateGetAddressBookParams object
// with the default values initialized.
func NewGetPrivateGetAddressBookParams() *GetPrivateGetAddressBookParams {
	var ()
	return &GetPrivateGetAddressBookParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetPrivateGetAddressBookParamsWithTimeout creates a new GetPrivateGetAddressBookParams object
...
// NewGetPrivateGetAddressBookParamsWithContext creates a new GetPrivateGetAddressBookParams object
...
// NewGetPrivateGetAddressBookParamsWithHTTPClient creates a new GetPrivateGetAddressBookParams object
...
/*GetPrivateGetAddressBookParams contains all the parameters to send to the API endpoint
for the get private get address book operation typically these are written to a http.Request
*/
