...
// NewGetPublicGetFooterParams creates a new GetPublicGetFooterParams object
// with the default values initialized.
func NewGetPublicGetFooterParams() *GetPublicGetFooterParams {

	return &GetPublicGetFooterParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetPublicGetFooterParamsWithTimeout creates a new GetPublicGetFooterParams object
...
// NewGetPublicGetFooterParamsWithContext creates a new GetPublicGetFooterParams object
...
// NewGetPublicGetFooterParamsWithHTTPClient creates a new GetPublicGetFooterParams object
...
/*GetPublicGetFooterParams contains all the parameters to send to the API endpoint
for the get public get footer operation typically these are written to a http.Request
*/
