...
// PrivateGetOrderHistoryResponse private get order history response
//
// swagger:model private_get_order_history_response
...
func (m *PrivateGetOrderHistoryResponse) validateResult(formats strfmt.Registry) error {
...
func (m *PrivateGetOrderHistoryResponse) UnmarshalBinary(b []byte) error {
	var res PrivateGetOrderHistoryResponse
