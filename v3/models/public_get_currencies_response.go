...
// PublicGetCurrenciesResponse public get currencies response
//
// swagger:model public_get_currencies_response
type PublicGetCurrenciesResponse struct {
	BaseMessage

	// result
	// Required: true
	Result []*CurrencyDetail `json:"result"`
}
...
// Validate validates this public get currencies response
...
func (m *PublicGetCurrenciesResponse) validateResult(formats strfmt.Registry) error {
...
func (m *PublicGetCurrenciesResponse) UnmarshalBinary(b []byte) error {
	var res PublicGetCurrenciesResponse
