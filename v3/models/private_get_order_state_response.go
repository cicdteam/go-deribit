...
// PrivateGetOrderStateResponse private get order state response
//
// swagger:model private_get_order_state_response
...
func (m *PrivateGetOrderStateResponse) validateResult(formats strfmt.Registry) error {
...
func (m *PrivateGetOrderStateResponse) UnmarshalBinary(b []byte) error {
	var res PrivateGetOrderStateResponse
